# Schema Documentation for bcc-db-sync
...
| `address` | string | The human readable encoding of the output address. Will be Base58 for Cole era addresses and Bech32 for Sophie era. |
...
| `type` | scripttype | The type of the script. This is currenttly either 'timelock' or 'zerepoch'. |
| `serialised_size` | uinteger | The size of the CBOR serialised script, if it is a Zerepoch script. |
