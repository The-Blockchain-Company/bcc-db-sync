...
BEGIN
  ...
  IF next_version = 1 THEN
    ...
    EXECUTE 'CREATe TABLE "tx"("id" SERIAL8  PRIMARY KEY UNIQUE,"hash" hash32type NOT NULL,"block_id" INT8 NOT NULL,"block_index" uinteger NOT NULL,"out_sum" isaac NOT NULL,"fee" isaac NOT NULL,"deposit" INT8 NOT NULL,"size" uinteger NOT NULL,"invalid_before" word64type NULL,"invalid_hereafter" word64type NULL)' ;
    ...
    EXECUTE 'CREATe TABLE "tx_out"("id" SERIAL8  PRIMARY KEY UNIQUE,"tx_id" INT8 NOT NULL,"index" txindex NOT NULL,"address" VARCHAR NOT NULL,"address_raw" BYTEA NOT NULL,"payment_cred" hash28type NULL,"stake_address_id" INT8 NULL,"value" isaac NOT NULL)' ;
    ...
    EXECUTE 'CREATe TABLE "epoch"("id" SERIAL8  PRIMARY KEY UNIQUE,"out_sum" word128type NOT NULL,"fees" isaac NOT NULL,"tx_count" uinteger NOT NULL,"blk_count" uinteger NOT NULL,"no" uinteger NOT NULL,"start_time" timestamp NOT NULL,"end_time" timestamp NOT NULL)' ;
    EXECUTE 'ALTER TABLE "epoch" ADD CONSTRAINT "unique_epoch" UNIQUE("no")' ;
    EXECUTE 'CREATe TABLE "bccxx_pots"("id" SERIAL8  PRIMARY KEY UNIQUE,"slot_no" uinteger NOT NULL,"epoch_no" uinteger NOT NULL,"treasury" isaac NOT NULL,"reserves" isaac NOT NULL,"rewards" isaac NOT NULL,"utxo" isaac NOT NULL,"deposits" isaac NOT NULL,"fees" isaac NOT NULL,"block_id" INT8 NOT NULL)' ;
    ...
    EXECUTE 'CREATe TABLE "pool_update"("id" SERIAL8  PRIMARY KEY UNIQUE,"hash_id" INT8 NOT NULL,"cert_index" INT4 NOT NULL,"vrf_key_hash" hash32type NOT NULL,"pledge" isaac NOT NULL,"reward_addr" addr29type NOT NULL,"active_epoch_no" INT8 NOT NULL,"meta_id" INT8 NULL,"margin" DOUBLE PRECISION NOT NULL,"fixed_cost" isaac NOT NULL,"registered_tx_id" INT8 NOT NULL)' ;
    ...
    EXECUTE 'CREATe TABLE "withdrawal"("id" SERIAL8  PRIMARY KEY UNIQUE,"addr_id" INT8 NOT NULL,"amount" isaac NOT NULL,"tx_id" INT8 NOT NULL)' ;
    ...
    EXECUTE 'CREATe TABLE "reward"("id" SERIAL8  PRIMARY KEY UNIQUE,"addr_id" INT8 NOT NULL,"type" rewardtype NOT NULL,"amount" isaac NOT NULL,"epoch_no" INT8 NOT NULL,"pool_id" INT8 NOT NULL)' ;
    ...
    EXECUTE 'CREATe TABLE "orphaned_reward"("id" SERIAL8  PRIMARY KEY UNIQUE,"addr_id" INT8 NOT NULL,"type" rewardtype NOT NULL,"amount" isaac NOT NULL,"epoch_no" INT8 NOT NULL,"pool_id" INT8 NOT NULL)' ;
    ...
    EXECUTE 'CREATe TABLE "epoch_stake"("id" SERIAL8  PRIMARY KEY UNIQUE,"addr_id" INT8 NOT NULL,"pool_id" INT8 NOT NULL,"amount" isaac NOT NULL,"epoch_no" INT8 NOT NULL)' ;
    ...
    EXECUTE 'CREATe TABLE "param_proposal"("id" SERIAL8  PRIMARY KEY UNIQUE,"epoch_no" uinteger NOT NULL,"key" hash28type NOT NULL,"min_fee_a" uinteger NULL,"min_fee_b" uinteger NULL,"max_block_size" uinteger NULL,"max_tx_size" uinteger NULL,"max_bh_size" uinteger NULL,"key_deposit" isaac NULL,"pool_deposit" isaac NULL,"max_epoch" uinteger NULL,"optimal_pool_count" uinteger NULL,"influence" DOUBLE PRECISION NULL,"monetary_expand_rate" DOUBLE PRECISION NULL,"treasury_growth_rate" DOUBLE PRECISION NULL,"decentralisation" DOUBLE PRECISION NULL,"entropy" hash32type NULL,"protocol_major" uinteger NULL,"protocol_minor" uinteger NULL,"min_utxo_value" isaac NULL,"min_pool_cost" isaac NULL,"registered_tx_id" INT8 NOT NULL)' ;
    ...
    EXECUTE 'CREATe TABLE "epoch_param"("id" SERIAL8  PRIMARY KEY UNIQUE,"epoch_no" uinteger NOT NULL,"min_fee_a" uinteger NOT NULL,"min_fee_b" uinteger NOT NULL,"max_block_size" uinteger NOT NULL,"max_tx_size" uinteger NOT NULL,"max_bh_size" uinteger NOT NULL,"key_deposit" isaac NOT NULL,"pool_deposit" isaac NOT NULL,"max_epoch" uinteger NOT NULL,"optimal_pool_count" uinteger NOT NULL,"influence" DOUBLE PRECISION NOT NULL,"monetary_expand_rate" DOUBLE PRECISION NOT NULL,"treasury_growth_rate" DOUBLE PRECISION NOT NULL,"decentralisation" DOUBLE PRECISION NOT NULL,"entropy" hash32type NULL,"protocol_major" uinteger NOT NULL,"protocol_minor" uinteger NOT NULL,"min_utxo_value" isaac NOT NULL,"min_pool_cost" isaac NOT NULL,"nonce" hash32type NULL,"block_id" INT8 NOT NULL)' ;
