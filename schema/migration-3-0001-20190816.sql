...
-- addresses.
create view utxo_cole_view as select
	tx_out.*
...
-- addresses.
-- This should produce the same query results as the above `utxo_cole_view` for Sophie addresses
-- and non-redeem Cole addresses.
